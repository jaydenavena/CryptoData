...
plt.axhline(percentile_values[0], c='green', label = '5th %ile')
plt.axhline(percentile_values[2], c='yellow', label = '50th %ile')
plt.axhline(percentile_values[-1], c='red', label = '95th %ile')
# plt.show()
# chart kinda funky idk what those spikes are, extreme swings as BTC does i think
